...
// ── WEEK 1 ── Big Adventures & Travel Appetite ──────────────
{
  ...
  questions: [
    ...
    { id: "w1q2", type: "scale", text: "Multnomah Falls is one of the tallest waterfalls in the US — about 30 min from Portland with a short hike to the viewpoint. How excited are you?", scale: { min: 1, max: 5, labels: ["Not for me", "Absolutely!"] }, place: "Multnomah Falls", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/9d/Multnomah_Falls_on_2_August_2012.jpg/330px-Multnomah_Falls_on_2_August_2012.jpg", imageLink: "https://en.wikipedia.org/wiki/Multnomah_Falls" },
    { id: "w1q3", type: "scale", text: "Timberline Lodge on Mt. Hood is about 1.5 hours away — the hotel used for exterior shots in The Shining. Incredible mountain views, great food, magical vibes. Worth a day trip?", scale: { min: 1, max: 5, labels: ["Not for me", "Absolutely!"] }, place: "Timberline Lodge", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/19/Timberline_Lodge_2014.jpg/330px-Timberline_Lodge_2014.jpg", imageLink: "https://en.wikipedia.org/wiki/Timberline_Lodge" },
    { id: "w1q4", type: "scale", text: "Astoria is about 2 hours away on the Oregon Coast — The Goonies was filmed here, plus there's a giant column you can climb and incredible Victorian architecture. Day trip material?", scale: { min: 1, max: 5, labels: ["Not for me", "Absolutely!"] }, place: "Astoria", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/7a/Astoria_Oregon.jpg/330px-Astoria_Oregon.jpg", imageLink: "https://en.wikipedia.org/wiki/Astoria,_Oregon" },
    { id: "w1q5", type: "scale", text: "The Oregon Coast (Cannon Beach, Haystack Rock) is 1.5-2 hours away. Dramatic scenery, tide pools, and great food. How interested are you?", scale: { min: 1, max: 5, labels: ["Not for me", "Absolutely!"] }, place: "Oregon Coast / Cannon Beach", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/df/Haystacks_Rocks_and_the_Needles%2CCannon_Beach.jpg/330px-Haystacks_Rocks_and_the_Needles%2CCannon_Beach.jpg", imageLink: "https://en.wikipedia.org/wiki/Haystack_Rock" },
    { id: "w1q6", type: "scale", text: "Hood River is about an hour east — windsurfing capital of the world, amazing fruit stands, local breweries, and stunning gorge views. Day trip?", scale: { min: 1, max: 5, labels: ["Not for me", "Absolutely!"] }, place: "Hood River", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3d/Hood_River_OR_-_aerial.jpg/330px-Hood_River_OR_-_aerial.jpg", imageLink: "https://en.wikipedia.org/wiki/Hood_River,_Oregon" },
    { id: "w1q7", type: "scale", text: "Willamette Valley wine country is about 45 min away — rolling vineyards, world-class Pinot Noir, gorgeous tasting rooms. Worth an afternoon?", scale: { min: 1, max: 5, labels: ["Not for me", "Absolutely!"] }, place: "Willamette Valley Wine Country", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/97/Wvatbethel1.jpg/330px-Wvatbethel1.jpg", imageLink: "https://en.wikipedia.org/wiki/Willamette_Valley_AVA" }
  ]
},
...
// ── WEEK 2 ── Portland's Personality ────────────────────────
{
  ...
  questions: [
    { id: "w2q1", type: "scale", text: "Powell's City of Books takes up an entire city block — it's the world's largest independent bookstore. How excited are you to visit?", scale: { min: 1, max: 5, labels: ["Not for me", "Absolutely!"] }, place: "Powell's City of Books", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8e/PowellsBookstore.jpg/330px-PowellsBookstore.jpg", imageLink: "https://en.wikipedia.org/wiki/Powell%27s_Books" },
    { id: "w2q2", type: "scale", text: "The Freakybuttrue Peculiarium is Portland's museum of oddities — alien autopsy, shrunken heads, carnival weirdness. Total Tim Burton energy. How into it are you?", scale: { min: 1, max: 5, labels: ["Not for me", "Absolutely!"] }, place: "Freakybuttrue Peculiarium", image: "https://upload.wikimedia.org/wikipedia/en/8/8d/Freakybuttrue_Peculiarium_logo.jpeg", imageLink: "https://en.wikipedia.org/wiki/Freakybuttrue_Peculiarium" },
    { id: "w2q3", type: "scale", text: "McMenamins Kennedy School is a real elementary school turned brewery/movie theater/hotel. Free to wander, murals everywhere. How interested are you?", scale: { min: 1, max: 5, labels: ["Not for me", "Absolutely!"] }, place: "McMenamins Kennedy School", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0d/Blitzweinhard_brewery.jpg/330px-Blitzweinhard_brewery.jpg", imageLink: "https://www.mcmenamins.com/kennedy-school" },
    { id: "w2q4", type: "scale", text: "Cathedral Park sits under the St. Johns Bridge — the gothic arches are straight out of a Tim Burton film. Perfect for a picnic at sunset. How appealing?", scale: { min: 1, max: 5, labels: ["Not for me", "Absolutely!"] }, place: "Cathedral Park", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/69/St_Johns_Bridge_from_Cathedral_Park_all_-_Portland,_Oregon.jpg/330px-St_Johns_Bridge_from_Cathedral_Park_all_-_Portland,_Oregon.jpg", imageLink: "https://en.wikipedia.org/wiki/Cathedral_Park_(Portland,_Oregon)" },
    { id: "w2q5", type: "scale", text: "Voodoo Doughnut is a Portland rite of passage — get the Voodoo Doll with the pretzel stake. Worth the tourist trap experience?", scale: { min: 1, max: 5, labels: ["Hard pass", "Absolutely!"] }, place: "Voodoo Doughnut", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/32/Voodoo_Doughnut_Portland%2C_Oregon_USA_01.jpg/330px-Voodoo_Doughnut_Portland%2C_Oregon_USA_01.jpg", imageLink: "https://www.voodoodoughnut.com" },
    { id: "w2q6", type: "scale", text: "Portland Saturday Market & PSU Farmers Market — handmade art, crafts, food pods, and farm-fresh goodies. Both run Saturdays. How excited are you? (Note: depending on your flight out on Saturday, this may not be an option.)", scale: { min: 1, max: 5, labels: ["Not for me", "Absolutely!"] }, place: "Saturday Market & PSU Farmers Market", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/fb/Tom_McCall_Waterfront_Park%2C_Willamette_River%2C_Portland_-_DPLA_-_8530ee13c0be47e3b4040550f1928858.jpg/330px-Tom_McCall_Waterfront_Park%2C_Willamette_River%2C_Portland_-_DPLA_-_8530ee13c0be47e3b4040550f1928858.jpg", imageLink: "https://www.portlandsaturdaymarket.com" },
...
// ── WEEK 3 ── Food Preferences ───────────────────────────────
{
  ...
  questions: [
    ...
    { id: "w3q2", type: "scale", text: "Salt & Straw is Portland's famous artisan ice cream shop with unusual flavors (honey lavender, bone marrow bourbon, etc). Worth a stop?", scale: { min: 1, max: 5, labels: ["Not for me", "Absolutely!"] }, place: "Salt & Straw", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/59/Salt_%26_Straw.jpg/330px-Salt_%26_Straw.jpg", imageLink: "https://saltandstraw.com" },
    { id: "w3q3", type: "scale", text: "Pine State Biscuits is legendary for massive Southern-style biscuit sandwiches. A Portland brunch institution. How interested are you?", scale: { min: 1, max: 5, labels: ["Not for me", "Absolutely!"] }, place: "Pine State Biscuits", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/be/Loveless_Cafe_Biscuits.jpg/330px-Loveless_Cafe_Biscuits.jpg", imageLink: "https://www.pinestatebiscuits.com" },
...
// ── WEEK 4 ── Drinks & Evening Vibes ────────────────────────
{
  ...
  questions: [
    { id: "w4q1", type: "scale", text: "Darcelle XV is Portland's legendary drag venue — the only drag club on the National Register of Historic Places (open since 1967). Friday and Saturday shows. How interested are you?", scale: { min: 1, max: 5, labels: ["Not for me", "Absolutely!"] }, place: "Darcelle XV Showplace", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/45/Darcelle_XV_Showplace%2C_CC_Slaughters%2C_Portland.JPG/330px-Darcelle_XV_Showplace%2C_CC_Slaughters%2C_Portland.JPG", imageLink: "https://en.wikipedia.org/wiki/Darcelle_XV_Showplace" },
    { id: "w4q2", type: "scale", text: "Rimsky-Korsakoffee House is a candlelit Victorian cafe open 7pm-midnight with haunted bathroom surprises and classical music. Deeply weird and wonderful. How into it are you?", scale: { min: 1, max: 5, labels: ["Not for me", "Absolutely!"] }, place: "Rimsky-Korsakoffee House", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/20/Portland%2C_OR_-_June_2025_-_28.jpg/330px-Portland%2C_OR_-_June_2025_-_28.jpg", imageLink: "https://en.wikipedia.org/wiki/Rimsky-Korsakoffee_House" },
...
// ── WEEK 5 ── Getting Outside ────────────────────────────────
{
  ...
  questions: [
    ...
    { id: "w5q2", type: "scale", text: "Forest Park is one of the largest urban forests in the US — miles of trails right inside the city. How interested are you in a short hike?", scale: { min: 1, max: 5, labels: ["Not for me", "Absolutely!"] }, place: "Forest Park", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6f/Forest_park_wildwood_trail_in_early_summer_P2860.jpeg/330px-Forest_park_wildwood_trail_in_early_summer_P2860.jpeg", imageLink: "https://en.wikipedia.org/wiki/Forest_Park_(Portland,_Oregon)" },
    { id: "w5q3", type: "scale", text: "Portland Japanese Garden in Washington Park is consistently rated one of the most authentic outside Japan. Peaceful and stunning. How interested are you?", scale: { min: 1, max: 5, labels: ["Not for me", "Absolutely!"] }, place: "Portland Japanese Garden", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a9/Japanese_Garden_-1.jpg/330px-Japanese_Garden_-1.jpg", imageLink: "https://japanesegarden.org" },
    { id: "w5q4", type: "scale", text: "Washington Park also has the International Rose Test Garden — free, beautiful, peak bloom in July/August. How interested are you?", scale: { min: 1, max: 5, labels: ["Not for me", "Absolutely!"] }, place: "International Rose Test Garden", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/48/Pdx_wash_mainentrance_sse.jpeg/330px-Pdx_wash_mainentrance_sse.jpeg", imageLink: "https://en.wikipedia.org/wiki/International_Rose_Test_Garden" },
...
// ── WEEK 6 ── Culture & Unique Experiences ──────────────────
{
  ...
  questions: [
    { id: "w6q1", type: "scale", text: "Alberta Arts District — galleries, murals, street art, eclectic shops. Best on foot. Last Thursday outdoor art walk is July 30. How interested are you?", scale: { min: 1, max: 5, labels: ["Not for me", "Absolutely!"] }, place: "Alberta Arts District", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a1/NE_Alberta_Street_Sticker_Urban_Art_Portland_%2817710824700%29.jpg/330px-NE_Alberta_Street_Sticker_Urban_Art_Portland_%2817710824700%29.jpg", imageLink: "https://en.wikipedia.org/wiki/Alberta_Arts_District" },
    { id: "w6q2", type: "scale", text: "Shanghai Tunnels tour — underground network allegedly used for shanghaiing sailors in Old Town Portland. Creepy history, guided tour. How interested are you?", scale: { min: 1, max: 5, labels: ["Not for me", "Absolutely!"] }, place: "Shanghai Tunnels", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/be/Shanghai_Tunnels.jpg/330px-Shanghai_Tunnels.jpg", imageLink: "https://en.wikipedia.org/wiki/Portland_Underground" },
    { id: "w6q3", type: "scale", text: "Portland Art Museum is the oldest art museum on the West Coast. Big collection, rotating exhibitions. How interested are you?", scale: { min: 1, max: 5, labels: ["Not for me", "Absolutely!"] }, place: "Portland Art Museum", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/1d/Portland_Art_Museum%2C_Portland%2C_Oregon.jpg/330px-Portland_Art_Museum%2C_Portland%2C_Oregon.jpg", imageLink: "https://portlandartmuseum.org" },
    ...
    { id: "w6q5", type: "scale", text: "Pearl District First Thursday gallery walk — galleries open late, free, very artsy crowd. August 6 would line up perfectly. How interested are you?", scale: { min: 1, max: 5, labels: ["Not for me", "Absolutely!"] }, place: "Pearl District Gallery Walk", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0d/Blitzweinhard_brewery.jpg/330px-Blitzweinhard_brewery.jpg", imageLink: "https://en.wikipedia.org/wiki/Pearl_District,_Portland,_Oregon" },
    { id: "w6q6", type: "scale", text: "Portland Fire is Portland's NEW women's professional basketball team — in their very first year! They're playing the Phoenix Mercury on September 17, which falls right during our trip. How interested are you in catching this historic home game?", scale: { min: 1, max: 5, labels: ["Not for me", "Absolutely!"] }, place: "Portland Fire vs. Phoenix Mercury", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/97/Modacenter2019.jpg/330px-Modacenter2019.jpg", imageLink: "https://www.wnba.com/team/fire" },
    { id: "w6q7", type: "scale", text: "Chapman Swift Watch is a free annual Portland tradition — every September, 7,000–10,000 migrating Vaux's swifts form a dramatic swirling cloud and funnel into the chimney at Chapman Elementary School to roost for the night. It's a magical, only-in-Portland spectacle. How interested are you?", scale: { min: 1, max: 5, labels: ["Not for me", "Absolutely!"] }, place: "Chapman Swift Watch", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/03/ChapmanSwiftsByKatSam.jpeg/330px-ChapmanSwiftsByKatSam.jpeg", imageLink: "https://audubonsociety.org/vaux-swifts" }
  ]
},
...
// ── WEEK 7 ── Shopping & Markets ────────────────────────────
{
  ...
  questions: [
    ...
    { id: "w7q3", type: "scale", text: "Mississippi Ave is a strip of independent shops, cafes, and restaurants in North Portland. How interested are you in spending time there?", scale: { min: 1, max: 5, labels: ["Not for me", "Absolutely!"] }, place: "Mississippi Ave", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a1/NE_Alberta_Street_Sticker_Urban_Art_Portland_%2817710824700%29.jpg/330px-NE_Alberta_Street_Sticker_Urban_Art_Portland_%2817710824700%29.jpg", imageLink: "https://en.wikipedia.org/wiki/Mississippi_Avenue_(Portland)" },
