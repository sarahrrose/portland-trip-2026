...
const QUESTIONS = [
  ...
  // ── WEEK 1 ── Big Adventures & Travel Appetite ──────────────
  {
    ...
    questions: [
      ...
      { id: "w1q2", type: "yesno_place", text: "Multnomah Falls is one of the tallest waterfalls in the US — about 30 min from Portland with a short hike to the viewpoint. Does that sound like your kind of thing?", place: "Multnomah Falls", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d5/Multnomah_Falls_in_2016.jpg/320px-Multnomah_Falls_in_2016.jpg", imageLink: "https://en.wikipedia.org/wiki/Multnomah_Falls" },
      { id: "w1q3", type: "yesno_place", text: "Timberline Lodge on Mt. Hood is about 1.5 hours away — it's the hotel from The Shining (exterior shots). Incredible mountain views, great food, magical vibes. Worth a day trip?", place: "Timberline Lodge", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/45/Timberline_Lodge_Mt_Hood.jpg/320px-Timberline_Lodge_Mt_Hood.jpg", imageLink: "https://en.wikipedia.org/wiki/Timberline_Lodge" },
      { id: "w1q4", type: "yesno_place", text: "Astoria is about 2 hours away on the Oregon Coast — The Goonies was filmed here, plus there's a giant column you can climb and incredible Victorian architecture. Day trip material?", place: "Astoria", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3c/Astoria_Column.jpg/320px-Astoria_Column.jpg", imageLink: "https://en.wikipedia.org/wiki/Astoria,_Oregon" },
      { id: "w1q5", type: "yesno_place", text: "The Oregon Coast (Cannon Beach, Haystack Rock) is 1.5-2 hours away. Dramatic scenery, tide pools, and great food. Interested?", place: "Oregon Coast / Cannon Beach", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b1/Haystack_Rock_Cannon_Beach.jpg/320px-Haystack_Rock_Cannon_Beach.jpg", imageLink: "https://en.wikipedia.org/wiki/Haystack_Rock" },
      { id: "w1q6", type: "yesno_place", text: "Hood River is about an hour east — windsurfing capital of the world, amazing fruit stands, local breweries, and stunning gorge views. Day trip?", place: "Hood River", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4e/Hood_River_Oregon_from_Vista_Point.jpg/320px-Hood_River_Oregon_from_Vista_Point.jpg", imageLink: "https://en.wikipedia.org/wiki/Hood_River,_Oregon" },
      { id: "w1q7", type: "yesno_place", text: "Willamette Valley wine country is about 45 min away — rolling vineyards, world-class Pinot Noir, gorgeous tasting rooms. Worth an afternoon?", place: "Willamette Valley Wine Country", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4e/Willamette_Valley_Vineyard.jpg/320px-Willamette_Valley_Vineyard.jpg", imageLink: "https://en.wikipedia.org/wiki/Willamette_Valley_AVA" }
    ]
  },
  ...
  // ── WEEK 2 ── Portland's Personality ────────────────────────
  {
    ...
    questions: [
      { id: "w2q1", type: "yesno_place", text: "Powell's City of Books takes up an entire city block — it's the world's largest independent bookstore. Must-do?", place: "Powell's City of Books", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a8/Powell%27s_City_of_Books_in_Portland%2C_Oregon.jpg/320px-Powell%27s_City_of_Books_in_Portland%2C_Oregon.jpg", imageLink: "https://en.wikipedia.org/wiki/Powell%27s_Books" },
      { id: "w2q2", type: "yesno_place", text: "The Freakybuttrue Peculiarium is Portland's museum of oddities — alien autopsy, shrunken heads, carnival weirdness. Total Tim Burton energy. In?", place: "Freakybuttrue Peculiarium", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3e/Freakybuttrue_Peculiarium_Portland.jpg/320px-Freakybuttrue_Peculiarium_Portland.jpg", imageLink: "https://en.wikipedia.org/wiki/Freakybuttrue_Peculiarium" },
      { id: "w2q3", type: "yesno_place", text: "McMenamins Kennedy School is a real elementary school turned bar/brewery/movie theater/hotel. Free to wander, murals everywhere, all ages. Interested?", place: "McMenamins Kennedy School", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f5/KennedySchoolPool.jpg/320px-KennedySchoolPool.jpg", imageLink: "https://www.mcmenamins.com/kennedy-school" },
      { id: "w2q4", type: "yesno_place", text: "Cathedral Park sits under the St. Johns Bridge — the gothic arches are straight out of a Tim Burton film. Perfect for a picnic at sunset. Yes?", place: "Cathedral Park", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/38/Cathedral_Park_Portland.jpg/320px-Cathedral_Park_Portland.jpg", imageLink: "https://en.wikipedia.org/wiki/Cathedral_Park_(Portland,_Oregon)" },
      { id: "w2q5", type: "yesno_place", text: "Voodoo Doughnut is a Portland rite of passage — get the Voodoo Doll with the pretzel stake. Worth the tourist trap experience?", place: "Voodoo Doughnut", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b7/Voodoo_Doll_Donut.jpg/320px-Voodoo_Doll_Donut.jpg", imageLink: "https://www.voodoodoughnut.com" },
      { id: "w2q6", type: "yesno_place", text: "Portland Saturday Market & PSU Farmers Market — Saturday Market is a massive outdoor handmade market along the waterfront (art, crafts, food pods), and the PSU Farmers Market is the city's best farm-fresh market one block away. Both run Saturdays — a great combo morning.", place: "Saturday Market & PSU Farmers Market", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0c/Portland_Saturday_Market.jpg/320px-Portland_Saturday_Market.jpg", imageLink: "https://www.portlandsaturdaymarket.com" },
  ...
  // ── WEEK 3 ── Food Preferences ───────────────────────────────
  {
    ...
    questions: [
      ...
      { id: "w3q2", type: "yesno_place", text: "Salt & Straw is Portland's famous artisan ice cream shop with unusual flavors (honey lavender, bone marrow bourbon, etc). Worth a stop?", place: "Salt & Straw", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/17/Salt_%26_Straw_ice_cream.jpg/320px-Salt_%26_Straw_ice_cream.jpg", imageLink: "https://saltandstraw.com" },
      { id: "w3q3", type: "yesno_place", text: "Pine State Biscuits is legendary for massive Southern-style biscuit sandwiches. A Portland brunch institution. In?", place: "Pine State Biscuits", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8b/Pine_State_Biscuits_Portland.jpg/320px-Pine_State_Biscuits_Portland.jpg", imageLink: "https://www.pinestatebiscuits.com" },
  ...
  // ── WEEK 4 ── Drinks & Evening Vibes ────────────────────────
  {
    ...
    questions: [
      { id: "w4q1", type: "yesno_place", text: "Darcelle XV is Portland's legendary drag venue — the only drag club on the National Register of Historic Places (open since 1967). Sunday brunch is all ages. Friday/Saturday shows may be 21+. Interested?", place: "Darcelle XV Showplace", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/2d/Darcelle_XV_Showplace_Portland.jpg/320px-Darcelle_XV_Showplace_Portland.jpg", imageLink: "https://en.wikipedia.org/wiki/Darcelle_XV_Showplace" },
      { id: "w4q2", type: "yesno_place", text: "Rimsky-Korsakoffee House is a candlelit Victorian cafe open 7pm-midnight with haunted bathroom surprises and classical music. Deeply weird and wonderful. In?", place: "Rimsky-Korsakoffee House", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/Rimsky_Korsakoffee_House.jpg/320px-Rimsky_Korsakoffee_House.jpg", imageLink: "https://en.wikipedia.org/wiki/Rimsky-Korsakoffee_House" },
  ...
  // ── WEEK 5 ── Getting Outside ────────────────────────────────
  {
    ...
    questions: [
      ...
      { id: "w5q2", type: "yesno_place", text: "Forest Park is one of the largest urban forests in the US — miles of trails right inside the city. Short hike appeal?", place: "Forest Park", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e0/Forest_Park_Portland.jpg/320px-Forest_Park_Portland.jpg", imageLink: "https://en.wikipedia.org/wiki/Forest_Park_(Portland,_Oregon)" },
      { id: "w5q3", type: "yesno_place", text: "Portland Japanese Garden in Washington Park is consistently rated one of the most authentic outside Japan. Peaceful and stunning. Interested?", place: "Portland Japanese Garden", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3e/Portland_Japanese_Garden_2.jpg/320px-Portland_Japanese_Garden_2.jpg", imageLink: "https://japanesegarden.org" },
      { id: "w5q4", type: "yesno_place", text: "Washington Park also has the International Rose Test Garden — free, beautiful, peak bloom in July/August. Worth a stroll?", place: "International Rose Test Garden", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/International_Rose_Test_Garden_Portland.jpg/320px-International_Rose_Test_Garden_Portland.jpg", imageLink: "https://en.wikipedia.org/wiki/International_Rose_Test_Garden" },
  ...
  // ── WEEK 6 ── Culture & Unique Experiences ──────────────────
  {
    ...
    questions: [
      { id: "w6q1", type: "yesno_place", text: "Alberta Arts District — galleries, murals, street art, eclectic shops. Best on foot. Last Thursday outdoor art walk is July 30. Worth an evening?", place: "Alberta Arts District", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4e/Alberta_Arts_District_Portland.jpg/320px-Alberta_Arts_District_Portland.jpg", imageLink: "https://en.wikipedia.org/wiki/Alberta_Arts_District" },
      { id: "w6q2", type: "yesno_place", text: "Shanghai Tunnels tour — underground network allegedly used for shanghaiing sailors in Old Town Portland. Creepy history, guided tour. In?", place: "Shanghai Tunnels", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/c/c3/Shanghai_Tunnels_Portland.jpg/320px-Shanghai_Tunnels_Portland.jpg", imageLink: "https://en.wikipedia.org/wiki/Portland_Underground" },
      { id: "w6q3", type: "yesno_place", text: "Portland Art Museum is the oldest art museum on the West Coast. Big collection, rotating exhibitions. Interested?", place: "Portland Art Museum", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/30/Portland_Art_Museum.jpg/320px-Portland_Art_Museum.jpg", imageLink: "https://portlandartmuseum.org" },
      ...
      { id: "w6q5", type: "yesno_place", text: "Pearl District First Thursday gallery walk — galleries open late, free, very artsy crowd. August 6 would line up perfectly.", place: "Pearl District Gallery Walk", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b5/Pearl_District_Portland.jpg/320px-Pearl_District_Portland.jpg", imageLink: "https://en.wikipedia.org/wiki/Pearl_District,_Portland,_Oregon" }
    ]
  },
  ...
  // ── WEEK 7 ── Shopping & Markets ────────────────────────────
  {
    ...
    questions: [
      ...
      { id: "w7q3", type: "yesno_place", text: "Mississippi Ave is a strip of independent shops, great restaurants, and vintage stores in a walkable neighborhood. Worth an afternoon?", place: "Mississippi Avenue", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/9e/Mississippi_Avenue_Portland.jpg/320px-Mississippi_Avenue_Portland.jpg", imageLink: "https://en.wikipedia.org/wiki/Mississippi_Avenue_(Portland,_Oregon)" },
