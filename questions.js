...
// ── WEEK 1 ── Big Adventures & Travel Appetite ──────────────
{
  ...
  questions: [
    ...
    { id: "w1q3", type: "scale", text: "Timberline Lodge on Mt. Hood is about 1.5 hours away — the hotel used for exterior shots in The Shining. Incredible mountain views, great food, magical vibes. Worth a day trip?", scale: { min: 1, max: 5, labels: ["Not for me", "Absolutely!"] }, place: "Timberline Lodge", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/48/Timberline_Lodge_-_Mount_Hood_-_Oregon.jpg/320px-Timberline_Lodge_-_Mount_Hood_-_Oregon.jpg", imageLink: "https://en.wikipedia.org/wiki/Timberline_Lodge" },
    ...
    { id: "w1q7", type: "scale", text: "Willamette Valley wine country is about 45 min away — rolling vineyards, world-class Pinot Noir, gorgeous tasting rooms. Worth an afternoon?", scale: { min: 1, max: 5, labels: ["Not for me", "Absolutely!"] }, place: "Willamette Valley Wine Country", image: "https://images.unsplash.com/photo-1506377247377-2a5b3b417ebb?w=280&h=180&fit=crop&q=80", imageLink: "https://en.wikipedia.org/wiki/Willamette_Valley_AVA" }
  ]
},
