...
const QUESTIONS = [
  ...
  // ── WEEK 2 ── Portland's Personality ────────────────────────
  {
    ...
    questions: [
      ...
      { id: "w2q4", type: "yesno_place", text: "Cathedral Park sits under the St. Johns Bridge — the gothic arches are straight out of a Tim Burton film. Perfect for a picnic at sunset. Yes?", place: "Cathedral Park", image: "https://images.unsplash.com/photo-1477959858617-67f85cf4f1df?w=280&h=180&fit=crop&q=80", imageLink: "https://en.wikipedia.org/wiki/Cathedral_Park_(Portland,_Oregon)" },
