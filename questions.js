...
const QUESTIONS = [
  ...
  // ── WEEK 1 ── Big Adventures & Travel Appetite ──────────────
  {
    ...
    questions: [
      ...
      { id: "w1q6", type: "yesno_place", text: "Hood River is about an hour east — windsurfing capital of the world, amazing fruit stands, local breweries, and stunning gorge views. Day trip?", place: "Hood River", image: "https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=280&h=180&fit=crop&q=80", imageLink: "https://en.wikipedia.org/wiki/Hood_River,_Oregon" },
      { id: "w1q7", type: "yesno_place", text: "Willamette Valley wine country is about 45 min away — rolling vineyards, world-class Pinot Noir, gorgeous tasting rooms. Worth an afternoon?", place: "Willamette Valley Wine Country", image: "https://images.unsplash.com/photo-1507434965515-61970f2bd7c6?w=280&h=180&fit=crop&q=80", imageLink: "https://en.wikipedia.org/wiki/Willamette_Valley_AVA" }
    ]
  },
