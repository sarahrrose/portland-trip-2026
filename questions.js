...
// ── WEEK 1 ── Big Adventures & Travel Appetite ──────────────
{
  ...
  questions: [
    ...
    { id: "w1q3", type: "scale", text: "Timberline Lodge on Mt. Hood is about 1.5 hours away — the hotel used for exterior shots in The Shining. Incredible mountain views, great food, magical vibes. Worth a day trip?", scale: { min: 1, max: 5, labels: ["Not for me", "Absolutely!"] }, place: "Timberline Lodge", image: "https://images.unsplash.com/photo-1551524559-8af4e6624178?w=280&h=180&fit=crop&q=80", imageLink: "https://en.wikipedia.org/wiki/Timberline_Lodge" },
